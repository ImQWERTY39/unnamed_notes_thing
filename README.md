...
I'm using SDL for the first time and not rely entirely on AI for any UI related stuff, but most of the other code is _definetly_ all my idea and the SDL part will be replaced for _my original_ ideas soon.
I expect to have a working prototype by December 2026. I haven't thought of a name for it yet and I'll be grateful for any non-AI contributions :)
...
* **Bitmapped Tiles:** Each $256 \times 256$ tile is stored as a 1-bit bitmap ($256 \times 4 \times 8$-byte chunks), making pixel operations and clearing incredibly fast.
